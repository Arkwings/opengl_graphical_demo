...
GLuint loadShaders(const char *vertex_path, const char *fragment_path,bool gs, const char * geometry_path) {
	...
	if(gs) geomShaderStr = readFile(geometry_path);
	std::string fragShaderStr = readFile(fragment_path);
	const char *vertShaderSrc = vertShaderStr.c_str();
	const char *geomShaderSrc;
	if(gs) geomShaderSrc = geomShaderStr.c_str();
